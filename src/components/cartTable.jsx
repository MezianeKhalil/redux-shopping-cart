                            ...
                            return (
                                <tr key={id} className={`${id%2 == 0? 'bg-gray-50':''}`}>
                                    ...
                                    <th className='font-medium py-3 capitalize'>
                                        <input onChange={(e)=>{updateAction(id, e.target.value)}} type="number" className="w-28 px-3 py-2 border-solid border-2 border-gray-100 rounded-sm" min={1} max={10} defaultValue={quantity} />
                                    </th>
                                    <th className='font-medium py-3 capitalize'>${Math.floor(price*quantity)}</th>
                                    <th className='font-medium py-3 capitalize'>
