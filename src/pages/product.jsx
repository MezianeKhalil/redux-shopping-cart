...
import { addToCart, getProducts } from '../store/store'
export default function Product() {
  ...
  const addToCartHandler = (product)=>{
    dispatch(addToCart({...product, quantity: parseInt(input.current.value)}))
  }
              ...
              <div className="grid grid-cols-12 gap-3">
                ...
                <div className="col-span-12 lg:col-span-4 xl:col-span-3">
                  ...
                  <div className="flex justify-between mt-2">
                      ...
                      <button onClick={()=>addToCartHandler(product)} className="py-2 px-3 bg-blue-600 text-white rounded-sm">Add To cart</button>
                  </div>
                </div>
